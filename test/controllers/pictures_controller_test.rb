...
class PicturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create picture" do
    assert_difference('Picture.count') do
      post pictures_url, params: { picture: { imageable_id: @picture.imageable_id, name: @picture.name } }
    end
  ...
  test "should update picture" do
    patch picture_url(@picture), params: { picture: { imageable_id: @picture.imageable_id, name: @picture.name } }
